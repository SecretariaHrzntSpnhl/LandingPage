...
export default function Game5({ onComplete, isCompleted }: Props) {
  ...
  return (
    <>
      ...
      {showSummary && (
        <div className={styles.finishModalOverlay} role="dialog" aria-modal="true" aria-labelledby="game5-summary-title">
          <div className={styles.finishModalContent}>
            <h3 id="game5-summary-title" className={styles.finishModalTitle}>¡Excelente!</h3>
