...
export default function Game1({ onComplete, isCompleted }: Props) {
  ...
  return (
    <>
      ...
      {showSummary && (
        <div className={styles.finishModalOverlay} role="dialog" aria-modal="true" aria-labelledby="game1-summary-title">
          <div className={styles.finishModalContent}>
            <h3 id="game1-summary-title" className={styles.finishModalTitle}>¡Excelente!</h3>
