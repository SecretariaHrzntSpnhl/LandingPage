  ...
  return (
    <div className={styles.gameCard}>
      ...
      {completionModalVisible && (
        <div className={styles.finishModalOverlay} role="dialog" aria-modal="true" aria-labelledby="game4-summary-title">
          <div className={styles.finishModalContent}>
            <h3 id="game4-summary-title" className={styles.finishModalTitle}>¡Excelente!</h3>
